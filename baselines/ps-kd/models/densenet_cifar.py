...
__all__ = ['CIFAR_DenseNet', 'CIFAR_DenseNet121']
...
class CIFAR_DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=100, bias=True):
...
def CIFAR_DenseNet121(num_classes=100, bias=True, **kwargs):
